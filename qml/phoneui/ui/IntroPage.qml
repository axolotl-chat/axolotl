...
TelegramPage {
    ...
    body: Item {
        ...
        Text {
            ...
            This app is not production ready yet, in particular it does not store conversations,\
            does not fully support groups and some attachments, does not handle many corner case errors,\
            and has other bugs and UI issues.<br><br>\
