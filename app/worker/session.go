...
func (*TextsecureAPI) EndSession(ID int64) error {
...
func (*TextsecureAPI) MarkSessionRead(ID int64) error {
	if ID != -1 {
...
func (*TextsecureAPI) DeleteSession(ID int64) {
	err := store.DeleteSession(ID)
	if err != nil {
		ui.ShowError(err)
	}
}
func (*TextsecureAPI) FilterSessions(sub string) {
